...
// iOS 26 (Liquid Glass) device frame — status bar, dynamic island, home indicator.
...
export function IOSDevice({ children, width = 402, height = 874, dark = false, color }: IOSDeviceProps) {
  const isDark = dark || color === "black";
